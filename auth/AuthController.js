...
// middleware added for auth with api key

const turfFindIntersectLineString = (req, res, next) => {
...
router.post('/mapUserTest', VerifyToken , turfFindIntersectLineString)
